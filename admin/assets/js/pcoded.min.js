...
// $('body').append('' +
//     '<div class="fixed-button">' + '<a href="https://codedthemes.com/item/datta-able-premium/" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-shopping-cart" aria-hidden="true"></i> Hello' +
//     '</a> ' + '</div>' + '');
// var $window = $(window);
